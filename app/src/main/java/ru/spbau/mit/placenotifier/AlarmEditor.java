...
//            Intent intent = new Intent(context, AbstractEditor.class);
//            if (prototype != null) {
...
public class AlarmEditor extends AbstractEditor<Alarm> {
    ...
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        onCreate(savedInstanceState, () -> new AlarmCustomizeEngine(this, 0), Alarm.class, R.layout.activity_alarm_editor);
    }
